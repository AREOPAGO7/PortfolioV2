    ...
    return (
        <div className="bg-[#111111]">
            <div className="hover: cursor-pointer group flex items-center">
                <h2 className="text-xl text-white/70 font-semibold mb-8 ml-6 z-1000">Recent Projects</h2>
            ...
            <section className=" relative">
                ...
                <div className="absolute left-0 top-0 bottom-0 w-48 bg-gradient-to-r from-[#111111] to-transparent pointer-events-none z-10" />
                ...
                <div className="flex justify-center items-center">
                    <div className="flex gap-4 w-full max-w-[1000px] relative">
                        <div className="absolute right-0 top-0 bottom-0 w-48 bg-gradient-to-l from-[#111111] to-transparent pointer-events-none z-10" />

                        <div className="bg-zinc-900 rounded-lg overflow-hidden w-20">
                        ...
                        {/* Other project cards */}
                        <div className="bg-zinc-900 rounded-lg overflow-hidden w-[290px]">
                        ...
                        <div className="bg-zinc-900 rounded-lg overflow-hidden w-[290px]">
                            <div className="relative h-[150px] rounded-lg overflow-hidden bg-zinc-900">
