                ...
                <div className="mb-20">
                    <div className="flex justify-between items-start gap-16">
                        <div className="flex flex-col items-start">
                            <span className="text-blue-400 text-xl font-semibold mb- relative left-118 ">magic</span>
                            <h1 className="text-4xl font-bold mb-4 text-white/80">
                            ...
                            <p className='text-[14px] mb-6 font-poppins font-semibold text-white/80'>Safi, Morocco</p>
                            ...
                            <div className='grid grid-cols-2 mt-6 justify-between items-center w-[78%] gap-2'>
